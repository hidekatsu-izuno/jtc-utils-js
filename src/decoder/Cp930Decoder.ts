...
const EbcdicMap = Uint16Array.of(
  ...
  0x0026, 0xff6a, 0xff6b, 0xff6c, 0xff6d, 0xff6e, 0xff6f,      0, 0xff70,      0, 0x0021, 0x00a5, 0x002a, 0x0029, 0x003b, 0x00ac, // 5x
  0x002d, 0x002f, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068,      0, 0x002c, 0x0025, 0x005f, 0x003e, 0x003f, // 6x
  ...
  0xff7f, 0xff80, 0xff81, 0xff82, 0xff83, 0xff84, 0xff85, 0xff86, 0xff87, 0xff88, 0xff89, 0x0072,      0, 0xff8a, 0xff8b, 0xff8c, // 9x
  ...
  0x0024,      0, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a,      0,      0,      0,      0,      0,      0, // Ex
  0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039,      0,      0,      0,      0,      0, 0x009f, // Fx
)

export class Cp930Decoder implements Decoder {
  private fatal
