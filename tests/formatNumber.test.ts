...
describe("formatNumber", () => {
  ...
  test("test localized format from number to string", () => {
    expect(formatNumber(1000.01, "###,###.##", { locale: enUS })).toBe("1,000.01")
    expect(formatNumber(1000.01, "###,###.##", { locale: fr })).toBe("1\u202f000,01")
    expect(formatNumber(1000.01, "###,###.##", { locale: de })).toBe("1.000,01")
  })
})
