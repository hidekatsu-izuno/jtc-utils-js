...
import { CsvWriter } from "../../../src/io/node/CsvWriter"
import { windows31j } from "../../../src/charset/windows31j.js"
import { MemoryWritableStream } from "../../../src/io/MemoryWritableStream.js"

describe('node.CsvWriter', () => {
  test("test write utf-8 csv with bom", async () => {
    const buf = new MemoryWritableStream()
    const writer = new CsvWriter(Writable.fromWeb(buf))
    try {
